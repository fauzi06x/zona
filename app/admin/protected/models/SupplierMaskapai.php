 ...
 */
class SupplierMaskapai extends CFormModel
{
	...
	{
		return array(
			array('akun_supp_maskapai, id_maskapai, url_maskapai', 'required'),
	...
	public function supplierMaskapai_list()
	{
	...
	public function supplierMaskapai_insert($params = null)
	{
		$dataCurl[]= $this->api_auth('api_user');
		$dataCurl[]= $this->api_auth('api_password');
	...
	public function supplierMaskapai_update($id = null,$params = null)
	{
	...
	public function supplierMaskapai_delete($id = null)
	{
