	...
	<div class="span12">
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				<?php
					echo CHtml::beginForm(array('maskapai/update/'.$maskapai['id_supp_maskapai']),'post', array('id'=>'add-form','class'=>'form-horizontal','enctype'=>'multipart/form-data'));
				?>
					...
					<div class="control-group">
						...
						<div class="controls">
							<div class="basic-toggle-button">
                                <input type="checkbox" class="toggle" name="Maskapai[status]" value="1" <?php echo $maskapai['status']==1 ? 'checked':''; ?>/>
