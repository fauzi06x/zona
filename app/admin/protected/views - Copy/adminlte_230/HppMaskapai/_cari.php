<div class="wide form">
	...
	<div class="input-group margin pull-right" style="margin-right:0 !important;">
		<select class="form-control search-select">
			...
			<option value="class_maskapai">Kelas Maskapai</option>
			<option value="hpp_maskapai">Persentase HPP</option>
			<option value="type_share">Tipe Share</option>
			<option value="value_share">Persentase Share</option>
		</select>
	</div>				
	<?php $this->endWidget(); ?>
</div>
