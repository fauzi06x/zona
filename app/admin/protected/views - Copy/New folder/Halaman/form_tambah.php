<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active"><i class="fa fa-pencil"></i> Tambah Halaman</li>
	</ol>
</section>
		...
		<div class="col-xs-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-pencil"></i> Tambah Halaman</h3>
				</div><!-- /.box-header -->
				<?php
					echo CHtml::beginForm(array('halaman/tambah'),'post', array('id'=>'form-tambah','class'=>'form-horizontal','enctype'=>'multipart/form-data'));
				?>
				<div class="box-body">
