...
<div class="row-fluid">
	<div class="span12">
		<h3 class="page-title">Tambah Hpp Maskapai</h3>
	</div>
</div>
<div class="row-fluid">
	<div class="span12">
		<div class="portlet box blue">
			<div class="portlet-title">
				<h4><i class="icon-plus"></i>Tambah Hpp Maskapai</h4>
				<div class="tools">
			...
			<div class="portlet-body form">
				<?php
					echo CHtml::beginForm(array('hppmaskapai/add'),'post', array('id'=>'add-form','class'=>'form-horizontal','enctype'=>'multipart/form-data'));
				?>
					...
					<div class="control-group" id="for_class_maskapai">
						...
						<div class="controls">
							<?php echo CHtml::activetextField($model,'class_maskapai', array('class'=>'m-wrap placeholder-no-fix', 'placeholder'=>'Class Maskapai')); ?>
					...
					<div class="control-group" id="for_hpp_maskapai">
						...
						<div class="controls">
							<?php echo CHtml::activetextField($model,'hpp_maskapai', array('class'=>'m-wrap placeholder-no-fix', 'placeholder'=>'Hpp Maskapai')); ?>
					...
					<div class="control-group" id="for_value_share">
						...
						<div class="controls">
							<?php echo CHtml::activetextField($model,'value_share', array('class'=>'m-wrap placeholder-no-fix', 'placeholder'=>'Hpp Maskapai')); ?>
