...
function del(id) {
	if(id!='')
		url = '<?php echo Yii::app()->baseUrl.'/news/delete/'; ?>' + id;
		...
		<div class="portlet box green">
			...
			<div class="portlet-body">
				...
				<table class="table table-striped table-bordered table-hover" id="table">
					...
					<tbody>
						<?php if($news): $no = 0; ?>
						<?php foreach($news as $key=>$val): $no++; ?>
						<tr id="<?php echo $val['id']; ?>">
							<td><?php echo $no; ?></td>
							<td><?php echo $val['title']; ?></td>
							<td>
								<a class="btn mini green" href="<?php echo Yii::app()->baseUrl.'/news/update/'.$val['id']; ?>"><i class="icon-edit"></i>Edit</a> 
