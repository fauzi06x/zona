	...
	<div class="span12">
		<div class="portlet box blue">
			<div class="portlet-title">
				<h4><i class="icon-plus"></i>Update Page</h4>
				<div class="tools">
			...
			<div class="portlet-body form">
				<?php
					echo CHtml::beginForm(array('page/update/'.$page['id']),'post', array('id'=>'add-form','class'=>'form-horizontal','enctype'=>'multipart/form-data'));
				?>
					<div class="control-group">
						<?php  echo CHtml::activeLabel($model, 'Title : ', array('class'=>'control-label'));?>
						<div class="controls">
							<?php echo CHtml::activetextField($model,'title', array('class'=>'m-wrap placeholder-no-fix', 'placeholder'=>'Title','value'=>$page['title'])); ?>
					...
					<div class="control-group">
						...
						<div class="controls">
							<?php echo CHtml::activeTextArea($model,'content', array('class'=>'span8 ckeditor', 'value'=>$page['content'])); ?>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">Image</label>
						<div class="controls">
							<div class="fileupload fileupload-<?php if($page['image'] != ''){ echo 'exists'; } else { echo 'new'; } ?>" data-provides="fileupload">
