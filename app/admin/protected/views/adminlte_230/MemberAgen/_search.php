<div class="wide form">
	...
	<div class="col-md-3 pull-right" style="padding-left:0 !important;">
		<div class="input-group margin">
			<input class="form-control search-input" type="text" name="MemberAgen[nama_lengkap]">
	...
	<div class="input-group margin pull-right" style="margin-right:0 !important;">
		<select class="form-control search-select">
			<option value="nama_lengkap">Nama Nengkap</option>
			<option value="nama_tipe">Tipe Agen</option>
			<option value="upline">Upline Premium</option>
