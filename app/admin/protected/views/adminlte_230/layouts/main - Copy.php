...
<html lang="en"> <!--<![endif]-->
	<head>
		...
		<?php
			...
			// <!-- jQuery 2.1.4 -->
			$cs->registerScriptFile('http://ajax.googleapis.com/ajax/libs/jquery/1.6.1/jquery.min.js');
			$cs->registerScriptFile($baseUrlTemplate.'/assets/plugins/jQuery/jQuery-2.1.4.min.js');
			// <!-- jQuery UI 1.11.4 -->
			...
			$cs->registerScriptFile($baseUrlTemplate.'/assets/plugins/datatables/jquery.dataTables.min.js');
			$cs->registerScriptFile($baseUrlTemplate.'/assets/plugins/datatables/dataTables.bootstrap.min.js');
			
			
			// <!-- Morris.js charts -->
			// $cs->registerScriptFile('https://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js');
			// $cs->registerScriptFile($baseUrlTemplate.'/assets/plugins/morris/morris.min.js');
			// <!-- Sparkline -->
			$cs->registerScriptFile($baseUrlTemplate.'/assets/plugins/sparkline/jquery.sparkline.min.js');
			// <!-- jvectormap -->
			$cs->registerScriptFile($baseUrlTemplate.'/assets/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js');
			$cs->registerScriptFile($baseUrlTemplate.'/assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js');
			// <!-- jQuery Knob Chart -->
			$cs->registerScriptFile($baseUrlTemplate.'/assets/plugins/knob/jquery.knob.js');
			// <!-- daterangepicker -->
			$cs->registerScriptFile('https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.2/moment.min.js');
			$cs->registerScriptFile($baseUrlTemplate.'/assets/plugins/daterangepicker/daterangepicker.js');
			// <!-- datepicker -->
			$cs->registerScriptFile($baseUrlTemplate.'/assets/plugins/datepicker/bootstrap-datepicker.js');
			// <!-- Bootstrap WYSIHTML5 -->
			$cs->registerScriptFile($baseUrlTemplate.'/assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js');
			// <!-- Bootstrap bootstrap-fileupload -->
			$cs->registerScriptFile($baseUrlTemplate.'/assets/plugins/bootstrap-fileupload/bootstrap-fileupload.js');
			// <!-- Slimscroll -->
			$cs->registerScriptFile($baseUrlTemplate.'/assets/plugins/slimScroll/jquery.slimscroll.min.js');
			
			Yii::app()->getClientScript()->registerScriptFile(Yii::app()->theme->baseUrl.'/assets/plugins/bootstrap-toggle-buttons/static/js/jquery.toggle.buttons.js');
			// <!-- FastClick -->
			$cs->registerScriptFile($baseUrlTemplate.'/assets/plugins/fastclick/fastclick.min.js');
			// <!-- AdminLTE App -->
			$cs->registerScriptFile($baseUrlTemplate.'/assets/dist/js/app.min.js');
			// <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
			// $cs->registerScriptFile($baseUrlTemplate.'/assets/dist/js/pages/dashboard.js');
			// <!-- AdminLTE for demo purposes -->
			$cs->registerScriptFile($baseUrlTemplate.'/assets/dist/js/demo.js');
			Yii::app()->getClientScript()->registerScriptFile(Yii::app()->theme->baseUrl.'/assets/plugins/ckeditor/ckeditor.js');
			$cs->registerScriptFile($baseUrlTemplate.'/assets/dist/js/demo.js');
